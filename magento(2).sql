...
--
-- Host: localhost
-- Generation Time: Sep 28, 2016 at 07:29 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Admin User sessions table' AUTO_INCREMENT=18 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Cataloginventory Stock Item' AUTO_INCREMENT=8 ;
...
(7, 7, 1, 153.0000, 0.0000, 1, 0, 0, 1, 1.0000, 1, 10000.0000, 1, 1, NULL, 1.0000, 1, 1, 1, 0, 1, 1.0000, 1, 0, 0, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product To Category Linkage Table' AUTO_INCREMENT=12 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Table' AUTO_INCREMENT=8 ;
...
(2, 4, 'simple', 'iPA DADO BIER', 0, 0, '2016-09-14 23:11:21', '2016-09-14 23:11:21'),
...
(7, 4, 'simple', 'Logo', 0, 0, '2016-09-22 01:36:06', '2016-09-22 01:36:06');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Datetime Attribute Backend Table' AUTO_INCREMENT=17 ;
...
(15, 94, 0, 7, '2016-09-21 00:00:00'),
(16, 95, 0, 7, '2016-09-29 00:00:00');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Media Gallery Attribute Value Table' AUTO_INCREMENT=15 ;
...
(3, 75, 0, 2, '<p>Cerveja India Pale Ale</p>'),
(4, 76, 0, 2, '<p>Teste</p>'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table' AUTO_INCREMENT=123 ;
...
(3, 86, 0, 1, 'Cerveja IPA Colorado '),
(4, 87, 0, 1, '/i/p/ipacolorado_1.jpg'),
(5, 88, 0, 1, '/i/p/ipacolorado_1.jpg'),
...
(113, 84, 0, 7, 'Logo'),
(114, 86, 0, 7, 'Logo '),
(115, 87, 0, 7, '/l/o/logocoloradoipa_1_1.jpeg'),
(116, 88, 0, 7, '/l/o/logocoloradoipa_1_1.jpeg'),
(117, 89, 0, 7, '/l/o/logocoloradoipa_1_1.jpeg'),
(118, 106, 0, 7, 'container2'),
(119, 119, 0, 7, 'logo'),
(120, 132, 0, 7, '/l/o/logocoloradoipa_1_1.jpeg'),
(121, 134, 0, 7, '2'),
(122, 136, 0, 7, '5');
...
(7, 4, 'simple', '1', NULL, '2016-09-22 01:36:06', NULL, 2, 0, '5', '/l/o/logocoloradoipa_1_1.jpeg', NULL, NULL, NULL, NULL, NULL, NULL, 'Logo', '2016-09-21 00:00:00', '2016-09-29 00:00:00', 18.0000, NULL, NULL, 0, NULL, 'Logo', NULL, '/l/o/logocoloradoipa_1_1.jpeg', NULL, NULL, NULL, NULL, '/l/o/logocoloradoipa_1_1.jpeg', 0, '/l/o/logocoloradoipa_1_1.jpeg', NULL, '2016-09-22 01:36:06', 'logo', NULL, 4, NULL, NULL);
...
(7, 0, 1, 0, 18.0000, 18.0000, 18.0000, 18.0000, NULL),
(7, 1, 1, 0, 18.0000, 18.0000, 18.0000, 18.0000, NULL),
(7, 2, 1, 0, 18.0000, 18.0000, 18.0000, 18.0000, NULL),
(7, 3, 1, 0, 18.0000, 18.0000, 18.0000, 18.0000, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Option Table' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Option Price Table' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Option Title Table' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Option Type Value Table' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Visitor Table' AUTO_INCREMENT=39 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Sales Flat Quote Address' AUTO_INCREMENT=8 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Quote ID and masked ID mapping' AUTO_INCREMENT=3 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Reports Compared Product Index Table' AUTO_INCREMENT=7 ;
...
(1, 30, NULL, 7, 1, '2016-09-22 02:27:28'),
(2, 30, NULL, 1, 1, '2016-09-22 02:28:55'),
(3, 32, NULL, 7, 1, '2016-09-22 22:34:35'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Url Rewrites' AUTO_INCREMENT=34 ;
...
(31, 'product', 7, 'logo.html', 'catalog/product/view/id/7', 0, 1, NULL, 1, NULL),
(32, 'product', 7, 'pilsen/logo.html', 'catalog/product/view/id/7/category/6', 0, 1, NULL, 1, 'a:1:{s:11:"category_id";s:1:"6";}'),
(33, 'product', 7, '/logo.html', 'catalog/product/view/id/7/category/2', 0, 1, NULL, 1, 'a:1:{s:11:"category_id";s:1:"2";}');
